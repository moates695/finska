...
import { Game, gameAtom, initialGame, newMemberNameAtom, newMemberNamesAtom, newNameAtom } from '@/store/general'
import { addMemberNameAtom, addPlayerAtom, addTeamAtom, getExistingGameNames, isMemberNameTakenAtom, isPlayerNameTakenAtom, isTeamNameTakenAtom, name_is_taken as nameIsTaken } from '@/store/actions';
...
describe('app participants', () => {
  it('get existing names', async () => {
    ...
    expect(await store.get(getExistingGameNames)).toEqual([]);
  ...
  it('add teams', async () => {
    ...
    expect(Object.values(team1.members)).toEqual(['member1','member2']);
